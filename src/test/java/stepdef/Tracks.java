...
public class Tracks {
	...
	public void i_can_update_that_tracks_entry() throws Throwable {
		...
		assertEquals(expected, result);
		driver.get("http://localhost:8082/html/tracks.html");
		Helper.snapShot(driver, "src/test/resources/reports/Track/updateTrack/shot6.png");
	}
	...
	public void i_can_delete_that_tracks_entry() throws Throwable {
		...
		driver.get("http://localhost:8082/html/tracks.html");
		Helper.snapShot(driver, "src/test/resources/reports/Track/deleteTrack/shot4.png");
